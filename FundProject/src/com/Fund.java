...
private Connection connect()
 ...
 "jdbc:mysql://127.0.0.1:3306/fund", "root", "");
 }
 catch (Exception e)
 {
 e.printStackTrace();
...
public String readFunds()
 ...
 output = "<table border='1'><tr><th>Fund Code</th><th>Fund Name</th><th>Fund Amount</th>"+ "<th>Fund Description</th><th>Update</th><th>Remove</th></tr>";
 ...
 String fundAmount = Double.toString(
 rs.getDouble("fundAmount"));
...
public String insertFund(String code, String name,
 ...
 String query = " insert into fund(`fundID`,`fundCode`,`fundName`,`fundAmount`,`fundDesc`)"
 + " values (?, ?, ?, ?, ?)";
		...
		public String updateFund(String ID, String code, String name,
		 String amount, String desc)
		 {
		 String output = "";
		 try
		 ...
		 // create a prepared statement
		 String query = "UPDATE fund SET fundCode=?,fundName=?,fundAmount=?,fundDesc=? WHERE fundID=?";
		 PreparedStatement preparedStmt = con.prepareStatement(query);
		 // binding values
