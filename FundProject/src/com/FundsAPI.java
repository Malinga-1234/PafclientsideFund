...
Map paras = getParasMap(request);
		...
		String output = fundObj.updateFund(paras.get("hidFundIDSave").toString(), paras.get("fundCode").toString(), 
				paras.get("fundName").toString(), paras.get("fundAmount").toString(), paras.get("fundDesc").toString());
